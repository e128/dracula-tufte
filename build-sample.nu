...
def body [] {
  [
    ...
    "      <p>Lists inside an indented container keep a margin of their own, since they have none by default and would otherwise butt against the paragraph above.</p>"
