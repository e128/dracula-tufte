...
def body [] {
  [
    ...
    "      <ul class=\"icon-list\">"
    "        <li style=\"--icon-color: var(--orange)\"><span class=\"icon-chip\">I</span><div><strong>Implement</strong><br/><code>implement the functionality</code></div></li>"
    "        <li style=\"--icon-color: var(--link)\"><span class=\"icon-chip\">I</span><div><strong>Identify</strong><br/><code>identify the bottleneck</code></div></li>"
    "        <li style=\"--icon-color: var(--green)\"><span class=\"icon-chip\">V</span><div><strong>Validate</strong><br/><code>verify behavioral correctness</code></div></li>"
    "      </ul>"
    "      <p>A step chain is for a flow too trivial to justify a Mermaid diagram. A graph with a branch or a loop still belongs in <code>pre.mermaid</code>.</p>"
    ...
    "        <div class=\"recent-group\"><h3>Category A</h3><ul class=\"nav-list\" role=\"list\"><li><a href=\"#\" title=\"Item One\">Item One</a> <span class=\"count\">2026-08-15</span></li></ul><a href=\"#\">view all 12 &rarr;</a></div>"
    "        <div class=\"recent-group\"><h3>Category B</h3><ul class=\"nav-list\" role=\"list\"><li><a href=\"#\" title=\"Item Two\">Item Two</a> <span class=\"count\">2026-08-15</span></li></ul><a href=\"#\">view all 533 &rarr;</a></div>"
    "        <div class=\"recent-group\"><h3>Category C</h3><ul class=\"nav-list\" role=\"list\"><li><a href=\"#\" title=\"Item Three\">Item Three</a> <span class=\"count\">2026-08-15</span></li></ul><a href=\"#\">view all 36 &rarr;</a></div>"
    "        <div class=\"recent-group\"><h3>Other</h3><ul class=\"nav-list\" role=\"list\"><li><a href=\"#\" title=\"Item Four\">Item Four</a> <span class=\"count\">2026-08-15</span></li></ul><a href=\"#\">view all 1689 &rarr;</a></div>"
    "      </div>"
    "    </section>"
    ""
    "    <section class=\"col-2\">"
